...
public class Translator {
  ...
  public String translate(String text, String languageFrom, String languageTo, String charset) throws IOException {
    ...
    Log.debug(charset + " ** " + stringBuilder.toString() + " ---- " + trans);
  ...
  public static String connect(String urlStr) throws IOException {
    ...
    Reader reader = new InputStreamReader(urlConnection.getInputStream(), Charset.UTF8);
