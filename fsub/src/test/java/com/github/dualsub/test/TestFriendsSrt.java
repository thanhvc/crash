...
public class TestFriendsSrt {
  ...
  public void setup() throws IOException {
    String srtEnFile = "/Users/thanhvc/Documents/english/Friends/season5/Friends_S502_eng.srt";
    String srtVnFile = "/Users/thanhvc/Documents/english/Friends/season5/Friends_S502_vn.srt";
	...
	public void testReadSrt() throws IOException {
		...
		Map<String, Entry> vnMap = srtVn.getSubtitles();
		
		Entry list;
		Set<String> keys = vnMap.keySet();
		List<String> listKeys = new ArrayList<String>(keys);
		int offset = 0;
		int limit = 10;
		
		int from = Math.max(offset + limit, listKeys.size());
		List<String> subList = listKeys.subList(offset, from);
